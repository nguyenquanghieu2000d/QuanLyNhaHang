...
import static sample.QuanLyMonAnController.*;

public class SuaMonAnController implements Initializable {
    ...
    @FXML public void ThemMonAn(ActionEvent event) throws SQLException {
        ...
        if(SuaMonAnDB(TextMaMonAn, TextTenMonAn.getText(), TextDonViTinh.getText(),TextDonGia.getText(), temp)) XacNhan.setText("Thêm thành công");
    ...
    @FXML public void editCommit(TableColumn.CellEditEvent editEvent){
        DanhSachNguyenLieuCuaMonAn b = table_.getSelectionModel().getSelectedItem();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        TextMaMonAn = getMonAn().getMaMonAn();
        TextTenMonAn.setText(getMonAn().getTenMonAn());
        TextDonViTinh.setText(getMonAn().getDonViTinh());
        TextDonGia.setText(getMonAn().getDonGia());
        ArrayList<DanhSachNguyenLieuCuaMonAn> b = getNguyenLieuMonAnDB();
        list2.addAll(b);
        temp.addAll(b);
        MaNguyenLieu_.setCellValueFactory(new PropertyValueFactory<DanhSachNguyenLieuCuaMonAn,String>("MaNguyenLieu"));
        TenNguyenLieu_.setCellValueFactory(new PropertyValueFactory<DanhSachNguyenLieuCuaMonAn,String>("TenNguyenLieu"));
